...
if ($res) {
  ...
  if ($count > 0) {
    // echo "<script>window.open('mail_area/mail2.php','_self')</script>";
    // require_once('mail_area/mail2.php');
  }
}
...
<body>
  ...
  <div class="offer">
    <div class="small-container">
      <div class="row">
        <div class="col-2">
          <a href="product_details.php?p_id=16"><img src="product_img/smartwatch.png" class="offer-img" /></a>
        </div>
        <div class="col-2">
