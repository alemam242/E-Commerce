...
<head>
    ...
    <title>RedHut | Admin | Products</title>
...
<body>
    <div class="side_bar">
        <div class="logo-details">
            <img src="../images/logo-white.png" alt="" style="width:100px;height:35px !important">
                ...
                <tbody>
                    ...
                    if ($result) {
                        while ($data = mysqli_fetch_array($result)) {
                            ...
                            <td><img src="../product_img/' . $data["p_img1"] . '" alt="" style="width:100px; height:100px; object-fit:contain; !important"></img></td>
                            <td>' . $data['p_name'] . '</td>
